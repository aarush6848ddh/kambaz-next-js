    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Gather fresh ingredients from the garden.</li>
          <li>Wash and prepare all vegetables thoroughly.</li>
          <li>Heat olive oil in a large pan over medium heat.</li>
          <li>Saute onions and garlic until fragrant.</li>
          <li>Add vegetables and season with herbs and spices.</li>
          <li>Simmer for 20-25 minutes until tender.</li>
      ...
      <div id="wd-images">
        ...
        <img id="wd-starship" width="400px" src="https://www.staradvertiser.com/wp-content/uploads/2021/08/web1_Starship-gap2.jpg" alt="Starship rocket" />
        <br />
        Loading a local image:
        <br />
        <img id="wd-teslabot" src="/teslabot.jpeg" height="200px" alt="Tesla Bot" />
      </div>
      <div id="wd-forms">
        <h4>Form Elements</h4>
        ...
        <form>
          ...
          <textarea id="wd-textarea" cols={30} rows={10} defaultValue="Lorem ipsum dolor sit
...
anim id est laborum."></textarea>
      ...
      <div id="wd-anchors">
        ...
        <a href="https://github.com/aarush6848ddh/kambaz-next-js" id="wd-github">My GitHub Repository</a>
      </div>
